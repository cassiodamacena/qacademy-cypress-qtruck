        ...
        <form onSubmit={handleSubmit} className="create-foodtruck-form">
          <fieldset>
            ...
            <div className="input-block">
              <label htmlFor="name">Nome *<span>Máximo de 80 caracteres</span></label>
              <input
                id="name"
                name="name"
                maxLength={80}
            ...
            <div className="input-block">
              <label htmlFor="details">Detalhes *<span>Máximo de 300 caracteres</span></label>
              <textarea
                id="details"
                name="details"
                maxLength={300}
            ...
            <div className="input-block">
              <label htmlFor="opening-hours">Horário de Funcionamento *<span>Máximo de 60 caracteres</span></label>
              <input
                id="openingHours"
                name="opening-hours"
                maxLength={60}
